...
func InitOptionMap() {
	...
	common.OptionMap["MultiKeyCooldownEnabled"] = strconv.FormatBool(common.MultiKeyCooldownEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "MultiKeyCooldownEnabled":
		common.MultiKeyCooldownEnabled = value == "true" || value == "1"
